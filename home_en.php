...
<div id="page">
    ...
    <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/headerbackgrround.jpg);">
        <div class="gtco-container">
            <div class="row">
    ...
    <div class="gtco-section" id="who are we">
        <div class="gtco-container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/php-logo.png" width="100px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">PHP</h2>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/MySQL-Logo.png" width="80px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">MySQL</h2>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/java.png" width="40px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">Java</h2>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/android_robot.png" width="70px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">Android</h2>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/.net.png" width="80px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">.NET</h2>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                    <div class="feature-center">
						<span>
						    <img src="images/logos/after%20effects.png" width="65px" height="65px">
						</span>
                        <h2 style="color:darkgrey; margin-top: 10%">After Effects</h2>
                    </div>
                </div>
    ...
    <!-- الاراء -->
    <div id="gtco-testimonial" style="display: none">
        <div class="gtco-container">
            <div class="row">
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
            ...
            <div class="row">
                <div class="col-md-4 animate-box" data-animate-effect="fadeIn">
                    <div class="gtco-staff">
                        ...
                        <h3>م.عبدالرحمن الحازمي</h3>
                        <strong class="role">مبرمج ومحلل بيانات</strong>
                ...
                <div class="col-md-4 animate-box" data-animate-effect="fadeIn">
                    <div class="gtco-staff">
                        ...
                        <h3>د.معتز أبو ساره</h3>
                        <strong class="role">أخصائي قواعد بيانات</strong>
                        <p>Quos quia provident consequuntur culpa facere ratione maxime commodi voluptates id repellat velit eaque aspernatur expedita. Possimus itaque adipisci.</p>
                        <ul class="gtco-social-icons">
                            <li><a href="#"><i class="icon-facebook"></i></a></li>
                            <li><a href="#"><i class="icon-twitter"></i></a></li>
    ...
    <!-- اللوقين المخفي  -->
    <div  style="display: none;" id="gtco-startedlog">
        <div class="gtco-container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                    <h2>Get Started</h2>
    ...
    <div class="gtco-container">
        ...
        <div class="row copyright text-center"  style="margin-top: -150px">
            <div class="col-md-12">
                ...
                <p class="pull-right">
                <ul class="gtco-social-icons">
                    <li><a href="https://twitter.com/ProgFields" title="ProgFields" target="_blank"><i class="icon-twitter"></i></a></li>
